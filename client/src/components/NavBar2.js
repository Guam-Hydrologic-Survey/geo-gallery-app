...
export function NavBar() {
    ...
    // 
    const xsectionBtn = document.createElement("button");
    xsectionBtn.type = "button";
    xsectionBtn.textContent = "Cross Sections of the Aquifer";
    xsectionBtn.innerHTML = /*html*/ `
    ...
    <span class="navbar-icon-tooltip">Cross Sections<br> of the Aquifer</span>
    `;

    const dropdown = createDropdownLinks();

    controls.append(aboutBtn, tutorialBtn, lengendBtn, xsectionBtn, dropdown);
