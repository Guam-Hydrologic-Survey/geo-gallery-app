/* 
Dock.js
Description: Creates the dock, which contains map widgets and controls (e.g., zoom buttons, layer controls)
Parameters: 'element' - the ID of the container for the dock
*/

export function Dock(element) {
