...
export function LayerToggle() {
    ...
    layer_toggle.querySelectorAll(`[data-bs-toggle="popover"]`).forEach(el => {
...
function ResetLayerButtons() {
    ...
    <ul class="list-group">
        <li class="reset-layers-checkbox list-group-item">
            ...
            <label class="form-check-label" for="${reset_layers_btns.polygons}">Geologic Map (Polygons)</label>
        </li>
        <li class="reset-layers-checkbox list-group-item">
            <input class="form-check-input me-1" type="checkbox" value="" id="${reset_layers_btns.points}" checked>
            <label class="form-check-label" for="${reset_layers_btns.points}">Points</label>
        </li>
        <li class="reset-layers-checkbox list-group-item">
            <input class="form-check-input me-1" type="checkbox" value="" id="${reset_layers_btns.boundaries}" checked>
            <label class="form-check-label" for="${reset_layers_btns.boundaries}">Boundaries</label>
        </li>
    </ul>
    `;
...
function LayerToggleContents(layer_toggle) {
                ...
                case 4:
                    ...
                    <div class="layer-row">
                        <div class="layer-toggle">
                            ...
                            <div class="layer-key">
                                <p class="layer-label text-bold-weight">${polygon_units[i].label}</p>
    ...
    for (let i = 0; i < point_units.length - 3; i++) {
        layer_row = /*html*/ `
            <div class="layer-row">
                ...
                <input class="form-check-input" type="checkbox" id="toggle-point-${point_units[i].number}" checked/>
            </div>`;
    ...
    const point_sinkhole = /* html */ `
        <div class="layer-row">
                ...
                <input class="form-check-input" type="checkbox" id="toggle-point-sinkhole" checked/>
            </div>
        `;
    ...
    const point_cave = /* html */ `
        <div class="layer-row">
                ...
                <input class="form-check-input" type="checkbox" id="toggle-point-cave" checked/>
            </div>
        `;
    ...
    <div class="layer-row">
            ...
            <input class="form-check-input" type="checkbox" id="toggle-point-aerial" checked/>
        </div>`;
